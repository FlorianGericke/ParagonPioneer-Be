    ...
    public void run() {
        for (Inserter insert : inserts) {
            repository.save(Recipe.builder()
                    .output(goodRepository.findByNameIs(insert.output).orElse(null))
                    .input1(goodRepository.findByNameIs(insert.i1).orElse(null))
                    .input2(goodRepository.findByNameIs(insert.i2).orElse(null))
                    .input3(goodRepository.findByNameIs(insert.i3).orElse(null))
                    .input4(goodRepository.findByNameIs(insert.i4).orElse(null))
                    .input5(goodRepository.findByNameIs(insert.i5).orElse(null))
                    .input6(goodRepository.findByNameIs(insert.i6).orElse(null))
                    .input7(goodRepository.findByNameIs(insert.i7).orElse(null))
                    .input8(goodRepository.findByNameIs(insert.i8).orElse(null))
                    .input9(goodRepository.findByNameIs(insert.i9).orElse(null))
                    .input10(goodRepository.findByNameIs(insert.i10).orElse(null))
